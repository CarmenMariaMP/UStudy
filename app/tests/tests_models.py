...
class AsignaturaModelTests(TestCase):
    ...
    def test_crear_asignatura_nombre_negativa(self):
        try:
            Asignatura.objects.create(
                nombre='a'*201, titulacion='Titulacion1', anyo=2012)
    ...
    def test_crear_asignatura_titulacion_negativa(self):
        try:
            Asignatura.objects.create(
                nombre='Nombre2', titulacion='a'*201, anyo=2012)
        except Exception as e:
            self.assertTrue(e.args[0] == "el valor es demasiado largo para el tipo character varying(200)\n" or
                            e.args[0] == "value too long for type character varying(200)\n")
    ...
    def test_crear_asignatura_anyo_negativo(self):
        try:
            Asignatura.objects.create(
                nombre='Nombre3', titulacion='Titulacion3', anyo=60000)
        except Exception as e:
            self.assertTrue(
                e.args[0] == "smallint fuera de rango\n" or e.args[0] == "smallint out of range\n")

    def test_crear_asignatura_nombre_vacio(self):
        try:
            Asignatura.objects.create(
                nombre=None, titulacion='Titulacion3', anyo=2020)
        except Exception as e:
    ...
    def test_crear_asignatura_titulacion_vacia(self):
        try:
            Asignatura.objects.create(
                nombre='Nombre5', titulacion=None, anyo=2020)
        except Exception as e:
    ...
    def test_crear_asignatura_anyo_vacio(self):
        try:
            Asignatura.objects.create(
                nombre='Nombre6', titulacion='Titulacion6', anyo=None)
        except Exception as e:
    ...
    def test_crear_asignatura_anyo_string(self):
        try:
            Asignatura.objects.create(
                nombre='Nombre7', titulacion='Titulacion7', anyo='')
        except Exception as e:
            self.assertTrue(
                "Field 'anyo' expected a number but got ''" in e.args[0])
...
class NotificacionModelTests(TestCase):
    ...
    def setUpTestData(cls):
        ...
        user = User.objects.create(
            username='nombreUsuario', password='password')
        ...
        asignatura = Asignatura.objects.create(
            nombre='NombreAsignatura', titulacion='TitulacionAsignatura', anyo=1)
        curso = Curso.objects.create(nombre='Curso1', descripcion='Descripcion1',
                                     fecha_publicacion='2020-01-01', asignatura=asignatura, propietario=usuario)
        Notificacion.objects.create(
            tipo=Notificacion.TipoNotificacion["COMENTARIO"], visto=False, usuario=usuario, referencia='curso/4', curso=curso, fecha='2020-01-01')

    def test_crear_notificacion_positiva(self):
        usuario = Usuario.objects.first()
        notificacion = Notificacion.objects.get(id=1)
        self.assertEquals(notificacion.tipo,
                          Notificacion.TipoNotificacion["COMENTARIO"])
        self.assertEquals(notificacion.fecha, datetime.datetime(
    ...
    def test_crear_notificacion_fecha_vacia(self):
        ...
        try:
            Notificacion.objects.create(
                tipo=Notificacion.TipoNotificacion["COMENTARIO"], fecha=None, visto=False, usuario=usuario)
        except Exception as e:
    ...
    def test_crear_notificacion_visto_vacio(self):
        ...
        try:
            Notificacion.objects.create(
                tipo=Notificacion.TipoNotificacion["COMENTARIO"], fecha='2020-01-01', visto=None, usuario=usuario)
        except Exception as e:
    ...
    def test_crear_notificacion_usuario_vacio(self):
        try:
            Notificacion.objects.create(
                tipo=Notificacion.TipoNotificacion["COMENTARIO"], fecha='2020-01-01', visto=False, usuario=None)
        except Exception as e:
    ...
    def test_crear_notificacion_tipo_vacio(self):
        ...
        try:
            Notificacion.objects.create(
                tipo=None, fecha='2020-01-01', visto=False, usuario=usuario)
        except Exception as e:
    ...
    def test_crear_notificacion_negativa(self):
        ...
        notificacion = Notificacion.objects.create(
            tipo="", fecha='2020-01-01', visto=False, usuario=usuario, referencia='curso/4', curso=curso)
        with self.assertRaises(Exception) as context:
            self.assertTrue(context.exception == {'refencia': [
                            'This field cannot be blank.'], 'tipo': ['This field cannot be blank.']})
...
class ValoracionModelTests(TestCase):
    ...
    def setUpTestData(cls):
        # Instanciar objetos sin modificar que se usan en todos los métodos
        user = User.objects.create(
            username='nombreUsuario1', password='password1')
        usuario = Usuario.objects.create(nombre='Nombre1', apellidos='Apellidos1', email='nombreMail@gmail.com',
                                         email_academico='nombreMail@alum.us.es', titulacion='Titulacion1', descripcion='Descripcion1',
                                         foto=None, dinero=10.0, django_user=user)
        asignatura = Asignatura.objects.create(
    ...
    def test_crear_valoracion_negativa_puntuacion(self):
        ...
        valoracion = Valoracion.objects.create(
            puntuacion=6, usuario=usuario, curso=curso)
        with self.assertRaises(Exception) as context:
            self.assertTrue(context.exception == {'puntuacion': [
                            'Ensure this value is less than or equal to 5.']})
            valoracion.full_clean()

        valoracion = Valoracion.objects.create(
            puntuacion=0, usuario=usuario, curso=curso)
        with self.assertRaises(Exception) as context:
            self.assertTrue(context.exception == {'puntuacion': [
    ...
    def test_crear_valoracion_curso_vacio(self):
        ...
        try:
            Valoracion.objects.create(
                puntuacion=None, usuario=usuario, curso=curso)
        except Exception as e:
    ...
    def test_crear_valoracion_puntuacion_vacia(self):
        ...
        try:
            Valoracion.objects.create(
                puntuacion=6, usuario=usuario, curso=None)
        except Exception as e:
...
class CursoModelTests(TestCase):
    ...
    def test_crear_curso_positiva(self):
        ...
        Curso.objects.create(nombre="Curso1", descripcion="Descripcion1", fecha_publicacion=fecha,
                             asignatura=Asignatura.objects.first(), propietario=Usuario.objects.first())
    ...
    def test_crear_curso_negative_nombre_longitud_max(self):
        ...
        with self.assertRaises(Exception) as context:
            fecha = datetime.datetime.now().date()
            Curso.objects.create(nombre="a"*101, descripcion="Descripcion1", fecha_publicacion=fecha,
                                 asignatura=Asignatura.objects.first(), propietario=Usuario.objects.first())
    ...
    def test_crear_curso_negative_descripcion_longitud_max(self):
        ...
        with self.assertRaises(Exception) as context:
            fecha = datetime.datetime.now().date()
            Curso.objects.create(nombre="Curso1", descripcion="a"*501, fecha_publicacion=fecha,
                                 asignatura=Asignatura.objects.first(), propietario=Usuario.objects.first())
...
class ArchivoModelTests(TestCase):
    ...
    def setUpTestData(cls):
        ...
        asignatura = Asignatura.objects.create(
            nombre='Nombre1', titulacion='Titulacion1', anyo=2012)
        Curso.objects.create(nombre="Curso1", descripcion="Descripcion1",
                             fecha_publicacion=fecha, asignatura=asignatura, propietario=usuario)

    def test_crear_archivo_positiva(self):
        fecha = datetime.datetime.now().replace(tzinfo=timezone.utc)
        Archivo.objects.create(nombre='Archivo1', fecha_publicacion=fecha,
                               curso=Curso.objects.first(), ruta='ruta.pdf')
    ...
    def test_crear_comentario_negative_texto_longitud_max(self):
        with self.assertRaises(Exception) as context:
            ...
            Archivo.objects.create(
                nombre='a'*201, fecha_publicacion=fecha, curso=Curso.objects.first(), ruta='ruta.pdf')
...
class ReporteModelTest(TestCase):
    ...
    def setUpTestData(cls):
        ...
        asignatura = Asignatura.objects.create(
            nombre='Nombre1', titulacion='Titulacion1', anyo=2012)
        curso = Curso.objects.create(nombre="Curso1", descripcion="Descripcion1", fecha_publicacion=datetime.datetime(
            2022, 3, 29, 0, 0, 0).replace(tzinfo=timezone.utc), asignatura=asignatura, propietario=usuario)
        archivo = Archivo.objects.create(nombre="Archivo1", fecha_publicacion=datetime.datetime(
            2022, 3, 29, 0, 0, 0).replace(tzinfo=timezone.utc), curso=curso, ruta="ruta.pdf")

        Reporte.objects.create(descripcion="Descripcion1", fecha=datetime.datetime(2022, 3, 31, 0, 0, 0).replace(
    ...
    def test_crear_reporte_positivo(self):
        ...
        fecha = datetime.datetime(
            2022, 3, 31, 0, 0, 0).replace(tzinfo=timezone.utc)
    ...
    def test_crear_reporte_negativo_descripcion_longitud_max(self):
        try:
            Reporte.objects.create(descripcion='a'*501, fecha=datetime.datetime(2022, 3, 30, 0, 0, 0).replace(
                tzinfo=timezone.utc), tipo=Reporte.TipoReporte["PLAGIO"], usuario=Usuario.objects.first(), archivo=Archivo.objects.first())
        except Exception as e:
            self.assertTrue(
                'el valor es demasiado largo para el tipo character varying(500)' in e.args[0])

    def test_crear_reporte_descripcion_vacia(self):
        try:
            Reporte.objects.create(descripcion=None, fecha=datetime.datetime(2022, 3, 30, 0, 0, 0).replace(
                tzinfo=timezone.utc), tipo=Reporte.TipoReporte["PLAGIO"], usuario=Usuario.objects.first(), archivo=Archivo.objects.first())
        except Exception as e:
    ...
    def test_crear_reporte_fecha_vacia(self):
        try:
            Reporte.objects.create(descripcion="Descripcion1", fecha=None,
                                   tipo=Reporte.TipoReporte["PLAGIO"], usuario=Usuario.objects.first(), archivo=Archivo.objects.first())
        except Exception as e:
    ...
    def test_crear_reporte_tipo_vacio(self):
        try:
            Reporte.objects.create(descripcion="Descripcion1", fecha=datetime.datetime(2022, 3, 30, 0, 0, 0).replace(
                tzinfo=timezone.utc), tipo=None, usuario=Usuario.objects.first(), archivo=Archivo.objects.first())
        except Exception as e:
    ...
    def test_crear_reporte_usuario_vacio(self):
        try:
            Reporte.objects.create(descripcion="Descripcion1", fecha=datetime.datetime(2022, 3, 30, 0, 0, 0).replace(
                tzinfo=timezone.utc), tipo=Reporte.TipoReporte["PLAGIO"], usuario=None, archivo=Archivo.objects.first())
        except Exception as e:
    ...
    def test_crear_reporte_archivo_vacio(self):
        try:
            Reporte.objects.create(descripcion="Descripcion1", fecha=datetime.datetime(2022, 3, 30, 0, 0, 0).replace(
                tzinfo=timezone.utc), tipo=Reporte.TipoReporte["PLAGIO"], usuario=Usuario.objects.first(), archivo=None)
        except Exception as e:
