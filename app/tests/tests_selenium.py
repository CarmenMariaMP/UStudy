...
class TestEditarPerfil(LiveServerTestCase):
    ...
    def test_editarperfil_fallido(self):
        ...
        driver.get(self.live_server_url+'/perfil/prueba')
        driver.find_element(By.ID, "editarPerfil").click()
        driver.find_element(By.CSS_SELECTOR, "body").click()
        driver.find_element(By.ID, "id_username").send_keys("prueba")
        driver.find_element(By.ID, "id_nombre").click()
        driver.find_element(By.CSS_SELECTOR, ".form-row").click()
        driver.find_element(By.ID, "id_nombre").send_keys("Prueba")
        driver.find_element(By.ID, "id_apellidos").click()
        driver.find_element(By.CSS_SELECTOR, "body").click()
        driver.find_element(By.ID, "id_apellidos").send_keys("Prueba Prueba")
        driver.find_element(By.ID, "id_descripcion").click()
        driver.find_element(By.ID, "id_contrasena").click()
        driver.find_element(By.ID, "id_contrasena").send_keys("pacopaco")
        driver.find_element(By.ID, "id_confirmar_contrasena").click()
    ...
    def test_editarperfil_exitoso(self):
        ...
        driver.find_element(By.ID, "id_contrasena").send_keys("pacopaco")
        driver.find_element(By.ID, "id_confirmar_contrasena").click()
        driver.find_element(By.ID, "id_confirmar_contrasena").send_keys("pacopaco")
        driver.find_element(By.ID, "actualizarBoton").click()
...
class TestEditarCurso(LiveServerTestCase):
    ...
    def test_editarcurso_exitoso(self):
        ...
        driver.find_element(By.ID, "pwd").send_keys("contrasena")
        driver.find_element(By.ID, "pwd").send_keys(Keys.ENTER)
        driver.get(self.live_server_url+'/inicio_profesor/')
        element = self.driver.find_element(By.LINK_TEXT, "Editar")
        actions = ActionChains(self.driver)
        actions.move_to_element(element).perform()
        driver.find_element(By.LINK_TEXT, "Editar").click()
        element = self.driver.find_element(By.CSS_SELECTOR, "body")
        driver.find_element(By.CSS_SELECTOR, ".pt-5").click()
        driver.find_element(By.ID, "id_nombre").send_keys("Prueba prueba")
        driver.find_element(By.ID, "id_descripcion").click()
        driver.find_element(By.CSS_SELECTOR, ".pt-5").click()
        driver.find_element(By.ID, "id_descripcion").send_keys("Esto es un texto de prueba")
    ...
    def test_editarcurso_fallido(self):
        ...
        driver.find_element(By.LINK_TEXT, "Editar").click()
        driver.find_element(By.CSS_SELECTOR, ".pt-5").click()
        element = driver.find_element(By.ID, "id_nombre")
        actions = ActionChains(driver)         
        actions.double_click(element).perform()
        driver.find_element(By.ID, "id_nombre").send_keys(" ")
        driver.find_element(By.CSS_SELECTOR, ".btn").click()
