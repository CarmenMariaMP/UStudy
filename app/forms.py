...
class UsuarioForm(forms.Form):
    ...
    email_academico = forms.EmailField(max_length=254 ,required=True, disabled=True, widget=forms.EmailInput(attrs={'class': 'form-control', 'placeholder': 'uvus@alum.us.es'}))
